...
1. **Watches** a target application's structured logs in real time, completely decoupled from it (no shared code, no Docker socket access — log file + a thin HTTP layer only).
